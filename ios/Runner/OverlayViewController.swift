...
/// OverlayViewController — Cửa sổ nổi "Hà Nhạy VIP" với hiệu ứng đẹp.
/// Hỗ trợ kéo thả toàn window bằng ngón tay.
class OverlayViewController: UIViewController {
    ...
    // Chấm xanh nhấp nháy — active indicator
    ...
    @objc private func onPan(_ g: UIPanGestureRecognizer) {
        ...
        switch g.state {
        case .began:
            // Nhấn nhẹ container khi bắt đầu kéo
